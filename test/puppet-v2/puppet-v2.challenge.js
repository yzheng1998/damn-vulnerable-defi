...
describe("[Challenge] Puppet v2", function () {
    ...
    it("Exploit", async function () {
        ...
        let wethAmt = await this.lendingPool.calculateDepositOfWETHRequired(
            ethers.utils.parseEther("1000000")
        );

        await this.weth.connect(attacker).deposit({ value: wethAmt });
        await this.weth
            .connect(attacker)
            .approve(this.lendingPool.address, wethAmt);
